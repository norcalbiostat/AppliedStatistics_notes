...
complete.case.mean <- mean(hiv$bsi_depress, useNA="always")
bsi_depress.ums[miss.dep.idx] <- complete.case.mean
```

```{r}
dplyr::bind_rows(data.frame(value = hiv$bsi_depress, method = "Original"),
          data.frame(value = bsi_depress.ums, method = "Unconditional mean substitution")
)
```
