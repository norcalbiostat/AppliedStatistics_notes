...
Is a thing that we should talk about.

* How correlated do objects have to be before using a RI model is worth the hassle to fit (or worse explain to reviewers)
