...
## `r emo::ji("warning")` Before you begin
...
### `r emo::ji("arrow_down_small")` Download R v 4.1+ {-#download_r}
...
### `r emo::ji("pencil2")` Install {-#install_r}
...
### `r emo::ji("cinema")` Video Tutorials for both R and R Studio. {-#install_vid}
...
> `r emo::ji("warning")` Check with your instructor about which packages to install. You typically do NOT need all of these. 
...
`r emo::ji("question")` I know the name of the function I want to use, but I'm not sure how to use it
...
`r emo::ji("question")` I want to use a function that does X, there must be a function for it but I don't know which one...
...
`r emo::ji("question")` I get an error message that I don't understand
